...
export default function Home(){
  ...
  //useEffect => permite a execução de funções, sem o carregamento da tela 
  useEffect(()=>{
    //carregar yodas as tarefas do Banco de Dados
    buscarTarefas();
  }, []);
  ...
  const buscarTarefas = async () => {
    try {
      //fetch => método GET é padrão não precis declarar
