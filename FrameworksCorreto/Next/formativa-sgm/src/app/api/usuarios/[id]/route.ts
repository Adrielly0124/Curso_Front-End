//Rotas que precisam do ID//Rotas que Precisam do ID (PATCH ou PUT, GET (one), DELETE)

import { deleteUsuario, getOneUsuario, updateUsuario } from "@/controllers/UsuariosController";
